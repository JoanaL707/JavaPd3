...
*/
String last name = "pedra";
char first initial = 'J'
String item description = "round"
...
boolean light status = true;
boolean game status = true;
boolean battery ststus = false; 
