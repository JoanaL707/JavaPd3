     ...
     */
       ...
       double groupSavings(int numTickets){
          if(numTickets >= 1 && numTickets <= 8){
              return 11.0*numTickets;
          } else if (numTickets >=9 && numTickets <=16){
            return 10.50 * numTickets;
          }else if(numTickets > 16){
            return 8.50*numTickets;
          }else{
...
int groceryDiscount(double totalSpent,int ConOfBean) {
  if (totalSpent >= 100 && totalSpent <= 200 && ConOfBean >= 3 ){
    return 10;
  }else if (totalSpent > 200 && ConOfBean > 4){
    return 25;
  }else{
    return 0;
  }
